...
PrivateData = @{
    PSData = @{
        ...
        Tags = @('Office365', 'Microsoft365', 'SharePoint', 'SharePointOnline', 'SPO', 'Microsoft')
        ProjectUri = 'https://learn.microsoft.com/powershell/sharepoint/sharepoint-online/introduction-sharepoint-online-management-shell'
